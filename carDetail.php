...
$query = "SELECT * FROM Posts NATURAL JOIN Carpooling_post WHERE id = :id";
...
<p>Start Location: <?php echo $item['start_location']; ?></p>
<p>Destination: <?php echo $item['destination']; ?></p>
<p>Car Color: <?php echo $item['car_color']; ?></p>
<p>Car Model: <?php echo $item['car_model']; ?></p>
<p>Car License: <?php echo $item['car_license']; ?></p>
<p>Driver: <?php echo $item['driver']; ?></p>

<form action="carDetail.php?id=<?php echo $itemId; ?>" method="post">
