...
$query = "SELECT * FROM Posts NATURAL JOIN House_rental_post WHERE id = :id";
...
<p>Rental Type: <?php echo $item['rental_type']; ?></p>
<p>Location: <?php echo $item['location']; ?></p>
<p>Start Date: <?php echo $item['start_date']; ?></p>
<p>End Date: <?php echo $item['end_date']; ?></p>

<form action="rentalDetail.php?id=<?php echo $itemId; ?>" method="post">
